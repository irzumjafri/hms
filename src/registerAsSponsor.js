  ...
  return (
    ...
    <section className="editMyProfileSponsor">
      <div className="editMyProfileSponsorContainer">
        ...
        <div class = "row">
          <div class = "col-md-12" >
            <div onClick={() => {createSponsorshipRequest();applicationStatus ? (setRouter("registered")) : (setRouter("unregistered"))}} class = "Button" className="button_green">REGISTER ME</div>
          </div>
        </div>
