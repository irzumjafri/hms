  ...
  return (
    <body>
     ...
     <section className = "sponsorHomepage">
        ...
        <div>
          <h1 className="label-left" /*Make the updates array work*/>Updates</h1>
          <h2>{updatesArray}</h2>
        </div>
        ...
        <div>
          ...
          Edit My Profile
              ...
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("sponsorshiprequests")} variant="primary" size="lg" block>
          ...
          <div class = "row">
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("sponsorprofiles")} variant="primary" size="lg" block>
          Sponsor Profiles
          </Button>{'  '}
          </div>
              <div class = "col-md-6" >
          ...
          <div class = "row">
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("meetingrequests")} variant="primary" size="lg" block>
          Meeting Requests
          </Button>{'  '}
          </div>
              <div class = "col-md-6" >
          ...
          Children Profiles
              ...
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("academicrecords")} variant="primary" size="lg" block>
          Academic Records
          </Button>
          </div>
          </div>
          ...
          <div class = "row">
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("editfaqs")} variant="primary" size="lg" block>
          Edit FAQs
          </Button>{'  '}
          </div>
              <div class = "col-md-6" >
          <Button button className = "button_green" onClick={() => setRouter("editcontactinformation")} variant="primary" size="lg" block>
